...
// Include the appropriate Wi-Fi library based on the board
...
char ssid[] = "Get lost";    // your network SSID (name)
char pass[] = "bansalankita27";    // your network password (use for WPA, or use as key for WEP)
